 ...
 * [encrypt].
 *
 * Der [ALIAS] ist in allen drei Apps **derselbe String**, aber das bedeutet
 * **kein** geteiltes Schlüsselmaterial: Android-Keystore-Schlüssel sind an die
 * App-UID gebunden, und jede App (eigene `applicationId`, eigene Sandbox)
 * besitzt ihren eigenen Schlüssel unter diesem Namen. Lobber, Caster und
 * Prodder verschlüsseln also jeweils mit einem eigenen Key und müssen
 * unabhängig voneinander onboarden — ein App-übergreifendes Teilen wäre nur
 * über IPC (z. B. einen signaturgeschützten ContentProvider) oder eine
 * Single-App-Architektur möglich.
 */
object KeyVault {
